...
SCRATCH = Path(r"C:\Users\USER\.codex\visualizations\2026\09\07\01a07b9c-e77d-7511-9f66-aafc92441f90\manipur-ranges")
...
def main() -> None:
    ...
    source = ROOT / "1971" / "Manipur" / f"1971 Manipur {district}.pdf"
    ...
    target = out / f"{district.lower()}-{first}-{last}.jpg"
