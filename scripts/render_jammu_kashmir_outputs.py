...
SCRATCH = Path(r"C:\Users\USER\.codex\visualizations\2026\09\07\01a07b9c-e77d-7511-9f66-aafc92441f90\jammu-kashmir-output-renders")
...
def main() -> None:
    ...
    print(f"Rendered {len(pdfs)} Jammu & Kashmir output PDFs to {SCRATCH}")
