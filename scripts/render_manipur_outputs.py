...
SCRATCH = Path(r"C:\Users\USER\.codex\visualizations\2026\09\07\01a07b9c-e77d-7511-9f66-aafc92441f90\manipur-output-renders-final")
...
def main() -> None:
    ...
    for jpg in SCRATCH.glob("**/*.jpg"):
        district = jpg.parent.name
        by_district.setdefault(district, []).append(jpg)
    ...
    print(f"Rendered {len(pdfs)} Manipur output PDFs to {SCRATCH}")
