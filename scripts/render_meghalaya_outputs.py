...
SCRATCH = Path(r"C:\Users\USER\.codex\visualizations\2026\09\07\01a07b9c-e77d-7511-9f66-aafc92441f90\meghalaya-output-renders-final")
...
def main() -> None:
    ...
    for pdf in pdfs:
        ...
        for suffix in ("_civic_amenities", "_medical_educational_amenities", "_tehsil_appendix"):
            if stem.endswith(suffix):
                ...
                break
        district = stem
        out = SCRATCH / district.lower().replace(" ", "_").replace("&", "and")
    ...
    print(f"Rendered {len(pdfs)} Meghalaya output PDFs to {SCRATCH}")
