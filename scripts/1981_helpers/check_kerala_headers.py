...
print("Civic:")
print_headers('Kerala/civic amenities/1981_Alleppey_civic_amenities.pdf')
print("MedEdu:")
print_headers('Kerala/mededu/1981_Alleppey_medical_educational_amenities.pdf')
print("Tehsil Appendix:")
print_headers('Kerala/tehsil appendix/1981_Alleppey_tehsil_appendix.pdf')
