...
CACHE_DIR = Path(r"C:\Users\USER\.codex\visualizations\2026\09\07\01a07b9c-e77d-7511-9f66-aafc92441f90\nagaland-locate")
...
def text_for(source_path: Path) -> str:
    ...
    with tempfile.TemporaryDirectory(prefix="nagaland-pdftext-") as temp_dir:
