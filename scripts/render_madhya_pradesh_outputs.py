...
OUT = ROOT / "output" / "pdf" / "1971_trimmed" / "Madhya Pradesh"
SCRATCH = Path(
    "C:/Users/USER/.codex/visualizations/2026/09/07/01a07b9c-e77d-7511-9f66-aafc92441f90/madhya-output-renders-final"
)
...
def main() -> None:
    ...
    make_sheet(all_images, SCRATCH / "Madhya_Pradesh_all_outputs_contact.png", 6, (480, 690))
